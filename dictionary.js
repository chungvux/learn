    ...
    async findOxford(word) {
        ...
        function getBDSimple(data) {
            try {
                ...
                audios[0] = `https://stream-dict-laban.zdn.vn/us/H/${encodeURIComponent(expression)}.mp3`;
                audios[1] = `https://stream-dict-laban.zdn.vn/uk/H/${encodeURIComponent(expression)}.mp3`;
